# 배종원의 프로젝트 멍냥고홈 입니다.
🎯 홈페이지 : http://ec2-13-124-206-98.ap-northeast-2.compute.amazonaws.com:8080/animal/index (임시 ID : admin / 임시 PW : 123)
📓 포트폴리오 PDF: https://drive.google.com/file/d/1b4cy2eNZ_HXo6_P5PQZ4FtA8tG-46PN5/view?usp=drive_link
### 목차
...
# 구현 기능
 ...
 - [x] 카카오회원은 비밀번호 변경을 비활성화하여 관리
 - [x] 게시글 관리에서 내가 작성한 글 확인, 더보기를 누르면 10개씩 게시글이 추가
 - [x] 좋아요 관리에서 내가 좋아요한 글 확인, 더보기를 누르면 10개씩 게시글이 추가
...
### 대댓글(comments)
- [x] 로그인 후 댓글 작성 가능
- [x] 대댓글 작성 시 자식 댓글은 부모 댓글 아래 위치
- [x] 댓글 수정시 텍스트가 textarea로 변경되고 수정 , 취소 버튼이 추가
- [x] 부모 댓글 삭제 시 자식 댓글은 함께 삭제
- [x] 게시글 삭제 시 해당 게시글의 모든 댓글은 삭제

### 좋아요(likes)
- [x] 개인분양, 보호센터, 지식공유 게시글 좋아요 가능
- [x] 게시글에 좋아요를 누르면 마이페이지에서 내가 좋아요 한 글을 모아보기
